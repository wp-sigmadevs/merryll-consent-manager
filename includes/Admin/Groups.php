	...
	public static function settings() {
		...
		->add_fields(
			array(
				...
				->set_help_text( esc_html__( 'Please enter cookie group title.', 'merryll-consent-manager' ) ),
				Field::make(
					'text',
				...
				->set_classes( 'two-col flex-wrap justify-content-end' )
				->set_help_text( esc_html__( 'Please enter cookie group identifier ID in lowercase. Example: analytics', 'merryll-consent-manager' ) ),
				Field::make(
					'textarea',
				...
				->set_classes( 'two-col flex-wrap justify-content-end' )
				->set_help_text( esc_html__( 'Please enter cookie group description.', 'merryll-consent-manager' ) ),
			)
		)
		->set_header_template(
			'
