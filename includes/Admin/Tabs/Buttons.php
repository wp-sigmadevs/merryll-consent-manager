...
class Buttons {
	...
	public static function settings() {
		...
		self::$fields[] = Field::make(
			...
			esc_html__( 'Accept-All Button Background Color', 'merryll-consent-manager' )
		)
		->set_classes( 'two-col flex-wrap justify-content-end no-top-border' )
		...
		self::$fields[] = Field::make(
			...
			esc_html__( 'Accept-All Button Hover Background Color', 'merryll-consent-manager' )
		)
		->set_classes( 'two-col flex-wrap justify-content-end no-top-border' )
		...
		self::$fields[] = Field::make(
			...
			esc_html__( 'Accept-Selected Button Background Color', 'merryll-consent-manager' )
		)
		->set_classes( 'two-col flex-wrap justify-content-end' )
		...
		self::$fields[] = Field::make(
			...
			esc_html__( 'Accept-Selected Button Hover Background Color', 'merryll-consent-manager' )
		)
		->set_classes( 'two-col flex-wrap justify-content-end' )
		...
		self::$fields[] = Field::make(
			...
			esc_html__( 'Reject-All Button Background Color', 'merryll-consent-manager' )
		)
		->set_classes( 'two-col flex-wrap justify-content-end' )
		...
		self::$fields[] = Field::make(
			...
			esc_html__( 'Reject-All Button Hover Background Color', 'merryll-consent-manager' )
		)
		->set_classes( 'two-col flex-wrap justify-content-end' )
