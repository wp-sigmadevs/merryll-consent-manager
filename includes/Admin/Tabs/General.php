...
class General {
	...
	public static function settings() {
		...
		self::$fields[] = Field::make(
			...
			esc_html__( 'Enable merryll Cookie?', 'merryll-consent-manager' )
		)
		->set_classes( 'two-col flex-wrap justify-content-end no-top-border' )
		->set_help_text( esc_html__( 'Please switch on to enable merryll cookie.', 'merryll-consent-manager' ) )
		->set_default_value( true );

		self::$fields[] = Field::make(
			'text',
			'merryll_cookie_name',
			esc_html__( 'Cookie Name', 'merryll-consent-manager' )
		)
		...
		self::$fields[] = Field::make(
			...
			esc_html__( 'Cookie expiration (Days)', 'merryll-consent-manager' )
		)
		->set_classes( 'two-col flex-wrap justify-content-end' )
		->set_help_text( esc_html__( 'Please enter cookie expiration days.', 'merryll-consent-manager' ) )
